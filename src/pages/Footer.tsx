            ...
            <div className="pb-5 md:pb-0">
              ...
              <ul className="mt-8 flex gap-6">
                <li className="bg-white p-1 rounded">
                  {" "}
                  <a href="#">
                    <Facebook className="text-blue-600 w-5" />
                  </a>
                </li>
                <li className="bg-white p-1 rounded">
                  {" "}
                  <a href="#">
                    <Youtube className="text-red-600 w-5" />
                  </a>
                </li>
                <li className="bg-white p-1 rounded">
                  {" "}
                  <a href="#">
                    <Github className="text-black w-5" />
                  </a>
                </li>
                <li className="bg-white p-1 rounded">
                  {" "}
                  <a href="#">
                    <Twitter className="text-blue-600 w-5" />
                  </a>
                </li>
              </ul>
            </div>
