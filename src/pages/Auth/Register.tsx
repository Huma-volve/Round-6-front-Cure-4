        ...
        <div className="lg:max-w-1/3 mt-20 lg:ml-55 px-5 lg:px-0">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <Button type="submit" className="text-white bg-[#145DB8] w-full cursor-pointer hover:bg-blue-700">{isLoading?<span className="animate-spin bg-white w-4 h-4 inline-block"></span>:'Submit'}</Button>
            </form>
          </Form>
          <p className="text-[#99A2AB] text-center pt-8 font-normal">Already have an account!<Link to="/" className="text-[#145DB8] cursor-pointer">Sign in</Link></p>
        </div>
      </div>
